...
function Perfil() {
  ...
  return !userData ? (
    ...
    <div className="h-full flex flex-col bg-gray-100 dark:bg-gray-700 shadow-xl overflow-y-scroll">
      ...
      <div className=" shadow-lg pb-3 rounded-b-3xl">
        ...
        <div className="grid px-7 py-2  items-center justify-around grid-cols-3 gap-4 divide-x divide-solid ">
          ...
          <div className="col-span-1 px-3 flex flex-col items-center ">
            <span className="text-2xl font-bold dark:text-gray-300">Plan</span>
            <span className="text-lg font-medium">{`${userData.nombreDePlan}`}</span>
          </div>
          <div className="col-span-1 flex flex-col items-center ">
      ...
      <div className="flex mx-auto mt-3 w-100 ">
        <a href="">
          {" "}
          <button
            className="p-2 shadow-lg  tr-300 w-100 font-medium  bg-red-600 rounded-md hover:bg-red-600 text-gray-50"
            onClick={HandleClick}
          >
            Cancelar membresía
          </button>
