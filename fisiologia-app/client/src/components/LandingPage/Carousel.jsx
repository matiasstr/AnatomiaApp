  ...
  return (
    <div className="flex flex-row-reverse items-center justify-around">
      <div
        ...
        className="carousel slide relative w-2/6 "
      ...
      >
        ...
        <div className="carousel-inner relative w-full overflow-hidden h-full rounded-3xl">
          <div className="carousel-item active relative float-left w-full h-full ">
            <img src={cerebro} className="block w-full h-full" alt="..." />
            <div className="carousel-caption hidden md:block absolute text-center"></div>
          </div>
          <div className="carousel-item relative float-left w-full">
            <img src={columna} className="block w-full" alt="..." />
            <div className="carousel-caption hidden md:block absolute text-center"></div>
          </div>
          <div className="carousel-item relative float-left w-full">
            <img src={mano} className="block w-full" alt="..." />
            <div className="carousel-caption hidden md:block absolute text-center"></div>
          </div>
        </div>
        <button
