  ...
  return (
    <div className="flex flex-row-reverse items-center justify-around">
      <div
        ...
        class="carousel slide relative w-2/6 "
      ...
      >
        ...
        <div class="carousel-inner relative w-full overflow-hidden h-full rounded-3xl">
          <div class="carousel-item active relative float-left w-full h-full ">
            <img src={cerebro} class="block w-full h-full" alt="..." />
            <div class="carousel-caption hidden md:block absolute text-center"></div>
          </div>
          <div class="carousel-item relative float-left w-full">
            <img src={columna} class="block w-full" alt="..." />
            <div class="carousel-caption hidden md:block absolute text-center"></div>
          </div>
          <div class="carousel-item relative float-left w-full">
            <img src={mano} class="block w-full" alt="..." />
            <div class="carousel-caption hidden md:block absolute text-center"></div>
          </div>
        </div>
        <button
